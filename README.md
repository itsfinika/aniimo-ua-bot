...
- **Footer links in `locales/uk.json`** — `post_footer.links` points at `https://t.me/AniimoUAChat`, `https://t.me/AniimoUABot`, and `https://discord.gg/aniimo` (the official Aniimo Discord). Replace the chat and bot URLs with your own community links; there is no environment variable for them.
